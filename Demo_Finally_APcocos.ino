...
void sensor() {
  ...
  soilValue = map(soilValue, 0, 1023, 100, 0); //將數值轉換為0%~100%表示
  ...
  Serial.println(F(" % "));
  Serial.print(F("sensor Free RAM: ")); Serial.println(getFreeRam(), DEC);
}
/************************************************************/
/*uploadData*/
void uploadData() {
  //  Serial.print(F("uploadData Free RAM: ")); Serial.println(getFreeRam(), DEC);
  ...
  do {
    ...
    //    Serial.print(F("uploadData connectTCP status:"));
    //    Serial.println(client.connected());
  } while ((!client.connected()) &&
           ((millis() - startTime) < connectTimeout));
  //  Serial.print("uploadData connect status:");
  //  Serial.println(client.connected());
...
void commandData() {
  do {
    client = cc3000.connectTCP(ip, 80); /*試著連線*/
    //    Serial.print(F("cmdData connectTCP status:"));
    //    Serial.println(client.connected());
  } while ((!client.connected()) &&
           ((millis() - startTime) < connectTimeout));
  //  Serial.print(F("commandData connect status:"));
  //  Serial.println(client.connected());
  ...
  if (client.connected()) {
    ...
    Serial.print(F("\n"));
    Serial.println(F("-------------------------------------"));
    //    Serial.print(F("commandData Free RAM: ")); Serial.println(getFreeRam(), DEC);
    client.close();
  } else {
